...
const api: LuduxApi = {
  ...
  settings: {
    ...
    restoreBackup: () =>
      ipcRenderer.invoke('settings:restoreBackup') as Promise<SettingsActionResult>,
    clearGameCache: () =>
    ...
    syncGame: (input: SyncGameInput) =>
      ipcRenderer.invoke('settings:syncGame', input) as Promise<SettingsActionResult>,
