...
Version courante : `v0.31.0`

## Installation

1. Téléchargez `Ludux-Setup-0.31.0-x64.exe` depuis [la dernière version publiée](https://github.com/Akamasu/Ludux/releases/latest).
...
La bibliothèque s'ouvre comme un livre illustré, avec quatre jeux par double page et une animation de feuilletage. Les vues grille et liste restent disponibles depuis la barre de filtres.
